...
shapes = []
shapes.extend([polygon(20, math.sqrt(2)*(W1/8), rotation=math.pi/4, translation=(W1/2, H1/2)), polygon(4, math.sqrt(2)*(W1/2), rotation=math.pi/4, translation=(W1/2, H1/2)), polygon(10, 50, translation=(50+(W1-100)/4, 50+(H1-100)/4)), polygon(4, 50, translation=(3*W1/4, 60)), polygon(5, 50, translation=(3*W1/4, 3*H1/4)), polygon(6, 50, translation=(1*W1/4, 3*H1/4))])
for shape in shapes:
